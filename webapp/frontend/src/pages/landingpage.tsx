  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Fill out a questionnaire about your demographics, employment, and
            medical history
          </p>
          <div className="grid">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Get suggested healthcare insurance plans that best fit your
            financial needs.
          </p>
          <div className="grid">
            <Image
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col items-center justify-center relative">
          ...
          <div className="h-[20rem] flex-col flex items-center justify-center mb-8">
            ...
            >
              <p className="text-[2rem] font-semibold">
                Get the <span className="text-[#5046e6]">care</span> you
                deserve.
              </p>
            </motion.div>
          </div>
        ...
        <motion.div>
          <Button
            className="w-40 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold h-12 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 transition-all duration-300"
            onClick={() => {
